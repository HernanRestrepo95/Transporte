...
<f:view>
    <html>
        ...
        <body>
            ...
            <h1>Nuev@ Conductor</h1>
            <h:form>
                <h:inputHidden id="validateCreateField" validator="#{conductor.validateCreate}" value="value"/>
                ...
                <br />
                <h:commandLink action="#{conductor.create}" value="Create"/>
                <br />
                <br />
