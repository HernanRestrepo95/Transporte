        ...
        <body>
            ...
            <h:form>
                <h:panelGrid columns="2">
                    ...
                    <h:outputText value="#{empresa.empresa.ciudad}" title="Ciudad" />
                    <h:outputText value="Departamento:"/>
                    <h:outputText value="#{empresa.empresa.departamento}" title="Departamento" />
                    <h:outputText value="Direccion:"/>
                    <h:outputText value="#{empresa.empresa.direccion}" title="Direccion" />
                    <h:outputText value="Nombre:"/>
                    <h:outputText value="#{empresa.empresa.nombre}" title="Nombre" />
                    <h:outputText value="NumeroDocumento:"/>
                    <h:outputText value="#{empresa.empresa.numeroDocumento}" title="NumeroDocumento" />
                    <h:outputText value="Pais:"/>
                    <h:outputText value="#{empresa.empresa.pais}" title="Pais" />
                    <h:outputText value="Telefono:"/>
                    <h:outputText value="#{empresa.empresa.telefono}" title="Telefono" />
                    <h:outputText value="representanteLegal:"/>
                    <h:panelGroup>
                        <h:outputText value="#{empresa.empresa.representanteLegal.nombre}"/>
                        <h:panelGroup rendered="#{empresa.empresa.representanteLegal != null}">
                            <h:outputText value=" ("/>
                            <h:commandLink value="Mostrar" action="#{representanteLegal.detailSetup}">
                                ...
                                <f:param name="jsfcrud.currentRepresentanteLegal" value="#{jsfcrud_class['com.mycompany.mavenproject1.jsf.classes.util.JsfUtil'].jsfcrud_method['getAsConvertedString'][empresa.empresa.representanteLegal][representanteLegal.converter].jsfcrud_invoke}"/>
                                <f:param name="jsfcrud.relatedController" value="empresa"/>
                                <f:param name="jsfcrud.relatedControllerType" value="com.mycompany.mavenproject1.jsf.classes.EmpresaController"/>
                            </h:commandLink>
                            <h:outputText value=" "/>
                            ...
                            <h:outputText value=" "/>
                            <h:commandLink value="Eliminar" action="#{representanteLegal.destroy}">
                                <f:param name="jsfcrud.currentEmpresa" value="#{jsfcrud_class['com.mycompany.mavenproject1.jsf.classes.util.JsfUtil'].jsfcrud_method['getAsConvertedString'][empresa.empresa][empresa.converter].jsfcrud_invoke}"/>
                                <f:param name="jsfcrud.currentRepresentanteLegal" value="#{jsfcrud_class['com.mycompany.mavenproject1.jsf.classes.util.JsfUtil'].jsfcrud_method['getAsConvertedString'][empresa.empresa.representanteLegal][representanteLegal.converter].jsfcrud_invoke}"/>
                                <f:param name="jsfcrud.relatedController" value="empresa"/>
                                <f:param name="jsfcrud.relatedControllerType" value="com.mycompany.mavenproject1.jsf.classes.EmpresaController"/>
                    ...
                    <h:panelGroup>
                        <h:outputText value="#{empresa.empresa.tipoIdentificacion.nombre}"/>
                        <h:panelGroup rendered="#{empresa.empresa.tipoIdentificacion != null}">
                            <h:outputText value=" ("/>
                            <h:commandLink value="Mostrar" action="#{tipoIdentificacion.detailSetup}">
                                <f:param name="jsfcrud.currentEmpresa" value="#{jsfcrud_class['com.mycompany.mavenproject1.jsf.classes.util.JsfUtil'].jsfcrud_method['getAsConvertedString'][empresa.empresa][empresa.converter].jsfcrud_invoke}"/>
                                <f:param name="jsfcrud.currentTipoIdentificacion" value="#{jsfcrud_class['com.mycompany.mavenproject1.jsf.classes.util.JsfUtil'].jsfcrud_method['getAsConvertedString'][empresa.empresa.tipoIdentificacion][tipoIdentificacion.converter].jsfcrud_invoke}"/>
                                <f:param name="jsfcrud.relatedController" value="empresa"/>
                                <f:param name="jsfcrud.relatedControllerType" value="com.mycompany.mavenproject1.jsf.classes.EmpresaController"/>
                            </h:commandLink>
                            <h:outputText value=" "/>
                    ...
                    <h:panelGroup>
                        <h:outputText rendered="#{empty empresa.empresa.lstVehiculo}" value="(No Items)"/>
                        <h:dataTable value="#{empresa.empresa.lstVehiculo}" var="item" 
                                     border="0" cellpadding="2" cellspacing="0" rowClasses="jsfcrud_odd_row,jsfcrud_even_row" rules="all" style="border:solid 1px" 
                                     rendered="#{not empty empresa.empresa.lstVehiculo}">
                            <h:column>
                                <f:facet name="header">
                                    <h:outputText value="Id"/>
                                </f:facet>
                ...
                <br />
                <h:commandLink action="#{empresa.remove}" value="Eliminar">
                    <f:param name="jsfcrud.currentEmpresa" value="#{jsfcrud_class['com.mycompany.mavenproject1.jsf.classes.util.JsfUtil'].jsfcrud_method['getAsConvertedString'][empresa.empresa][empresa.converter].jsfcrud_invoke}" />
                </h:commandLink>
                <br />
                <br />
                ...
                <br />
                <h:commandLink action="#{empresa.listSetup}" value="Mostrar Empresa Items"/>
                <br />
                <br />
