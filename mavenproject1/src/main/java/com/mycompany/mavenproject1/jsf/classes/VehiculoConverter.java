...
public class VehiculoConverter implements Converter {
    ...
    public Object getAsObject(FacesContext facesContext, UIComponent component, String string) {
        ...
        VehiculoClient vehiculoClient = new VehiculoClient();
    ...
    public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
        ...
        if (object instanceof Vehiculo) {
            ...
            throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: com.transportationweb.transportationweb.entity.Vehiculo");
        }
    }
